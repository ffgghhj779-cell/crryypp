  ...
  return (
    <header
      ...
      style={{
        ...
        paddingBottom: '16px',
        /* PHASE 3: bumped min-height from 70px to 84px */
        minHeight:     '84px',
    ...
    >
      ...
      <div className="shrink-0 min-w-[80px] flex justify-end">
        {/* PHASE 3: bumped badge text to text-xs, bigger padding */}
