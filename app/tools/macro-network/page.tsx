      ...
      <div className="px-4 flex flex-col gap-5 mt-4">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-orange-500/80 font-bold tracking-widest uppercase text-xs animate-pulse">جاري فحص الشبكة...</p>
          </div>
        ) : (
          <motion.div 
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mt-2">
              <div className="rounded-2xl border border-white/[0.05] bg-[#0d0d0d] p-5 flex flex-col gap-2 relative overflow-hidden">
                ...
                <span className="text-2xl font-black text-white/90 font-mono dir-ltr text-right">
                  {data.hashrate} <span className="text-xs text-white/40">EH/s</span>
                </span>
              </div>
              ...
              <div className="rounded-2xl border border-white/[0.05] bg-[#0d0d0d] p-5 flex flex-col gap-2 relative overflow-hidden">
                ...
                <span className="text-2xl font-black text-white/90 font-mono dir-ltr text-right">
                  {data.difficulty} <span className="text-xs text-white/40">T</span>
                </span>
              </div>
            </div>

            <div className="rounded-2xl border border-white/[0.05] bg-[#0d0d0d] p-5 flex items-center justify-between mt-1">
              <span className="text-[10px] text-white/40 font-bold uppercase tracking-widest">عدد المعدنين النشطين تقريباً</span>
