  ...
  return (
    <div className="flex flex-col h-full bg-[#0a0a0a] overflow-y-auto pb-10" dir="rtl">
      ...
      <div className="px-5 pt-5 pb-4 flex flex-col gap-1">
        ...
        <h1 className="text-xl font-black text-white tracking-tight mt-1">ط§ظ„ط´ظ…ط¹ط© ط§ظ„ظ…ط®ظپظٹط©</h1>
        <p className="text-sm text-white/40 font-mono leading-relaxed">
          طھظˆظ‚ط¹ ط´ظƒظ„ ظˆط£ظ‡ط¯ط§ظپ ط§ظ„ط´ظ…ط¹ط© ط§ظ„ظ‚ط§ط¯ظ…ط© ظ‚ط¨ظ„ ط£ظ† طھطھط´ظƒظ„ ظپظٹ ط§ظ„ط³ظˆظ‚
        </p>
      </div>
      ...
      <div className="px-5 flex flex-col gap-5 mt-4">
        {isLoading || !predicted ? (
          <div className="flex flex-col items-center justify-center py-20 gap-6">
            ...
            <p className="text-fuchsia-500/80 font-bold tracking-widest uppercase text-base animate-pulse">ط¬ط§ط±ظٹ طھظˆظ‚ط¹ ط§ظ„ط´ظ…ط¹ط© ط§ظ„ظ‚ط§ط¯ظ…ط©...</p>
          </div>
        ) : (
          <motion.div 
          ...
          >
            <div className="flex justify-center mb-4">
              <h2 className="text-lg font-bold text-white/70 border-b border-white/10 pb-2">
                ط§ظ„ظ‡ط¯ظپ ط§ظ„ظ…طھظˆظ‚ط¹ ظ„ظ„ط´ظ…ط¹ط© ط§ظ„ظ‚ط§ط¯ظ…ط©
              </h2>
            </div>
            ...
            <div className="flex items-center justify-center py-8 relative">
              ...
              <div className="absolute right-4 top-0 flex items-center gap-3">
                <span className="text-sm text-white/40 font-bold uppercase tracking-widest">ط£ط¹ظ„ظ‰ ط³ط¹ط± ظ…طھظˆظ‚ط¹</span>
                <span className="text-lg font-mono font-black text-white/90">{formatPrice(predicted.high)}</span>
              </div>
              
              <div className="absolute left-4 bottom-0 flex items-center gap-3">
                <span className="text-lg font-mono font-black text-white/90">{formatPrice(predicted.low)}</span>
                <span className="text-sm text-white/40 font-bold uppercase tracking-widest">ط£ط¯ظ†ظ‰ ط³ط¹ط± ظ…طھظˆظ‚ط¹</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <div className={`rounded-xl p-6 flex flex-col gap-1 items-center justify-center border ${predicted.isBullish ? 'bg-emerald-500/5 border-emerald-500/10' : 'bg-red-500/5 border-red-500/10'}`}>
                <span className="text-sm text-white/50 uppercase font-bold tracking-widest">ط³ط¹ط± ط§ظ„ط¥ط؛ظ„ط§ظ‚ ط§ظ„ظ…طھظˆظ‚ط¹</span>
              ...
              <div className="rounded-xl p-6 flex flex-col gap-1 items-center justify-center border border-white/5 bg-white/[0.02]">
                <span className="text-sm text-white/50 uppercase font-bold tracking-widest">ط§ظ„ط§طھط¬ط§ظ‡ ط§ظ„ظ…طھظˆظ‚ط¹</span>
                <span className={`text-lg font-black ${predicted.isBullish ? 'text-emerald-400' : 'text-red-400'}`}>
                  {predicted.isBullish ? 'طµط§ط¹ط¯ ًں“ˆ' : 'ظ‡ط§ط¨ط· ًں“‰'}
                </span>
              </div>
            </div>
