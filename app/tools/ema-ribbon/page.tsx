 ...
 *
 * EMA Ribbon (ط´ط±ظٹط· ط§ظ„ظ…طھظˆط³ط·ط§طھ)
    ...
    <div className="flex flex-col h-full bg-[#0a0a0a] overflow-y-auto pb-10" dir="rtl">
      ...
      <div className="px-5 pt-5 pb-4 flex flex-col gap-1">
        ...
        <h1 className="text-xl font-black text-white tracking-tight mt-1">
          ط´ط±ظٹط· ط§ظ„ظ…طھظˆط³ط·ط§طھ (EMA Ribbon)
        </h1>
        <p className="text-sm text-white/40 font-mono leading-relaxed">
          طھط­ظ„ظٹظ„ ظ‚ظˆط© ط§ظ„ط§طھط¬ط§ظ‡ ط¨ظ†ط§ط،ظ‹ ط¹ظ„ظ‰ 8 ظ…طھظˆط³ط·ط§طھ ط£ط³ظٹط© (ط£ط±ظ‚ط§ظ… ظپظٹط¨ظˆظ†ط§طھط´ظٹ)
        </p>
      </div>
      ...
      <div className="px-5 flex flex-col gap-5">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md p-5 flex flex-col gap-6 shadow-xl shadow-black/50">
          ...
          >
            ...
            {loading ? 'ط¬ط§ط±ظچ ط§ظ„طھط­ظ„ظٹظ„...' : 'طھط´ط؛ظٹظ„ ط´ط±ظٹط· ط§ظ„ظ…طھظˆط³ط·ط§طھ'}
          </button>
        </div>
          ...
          {result && (
            ...
            >
              ...
              <div className="rounded-2xl border border-white/[0.08] bg-[#111] p-5 flex flex-col items-center justify-center shadow-lg relative overflow-hidden">
                ...
                <p className="text-sm font-bold text-white/40 uppercase tracking-widest mb-1 z-10">ط­ط§ظ„ط© ط§ظ„ط´ط±ظٹط· (Ribbon State)</p>
              ...
              <div className="rounded-2xl border border-white/[0.08] bg-[#0c0c0c] p-6 flex flex-col shadow-xl">
                <div className="flex items-center gap-3 mb-3 px-1">
                  ...
                  <span className="text-sm font-bold text-white/50 uppercase tracking-widest">ط§ظ„ظ…طھظˆط³ط·ط§طھ ط§ظ„ط£ط³ظٹط© (EMAs)</span>
                </div>
...
// â”€â”€ SVG Ribbon Component â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
