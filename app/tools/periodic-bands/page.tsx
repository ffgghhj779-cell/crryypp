      ...
      <div className="px-5 flex flex-col gap-5 mt-4">
        {isLoading || !bands ? (
          <div className="flex flex-col items-center justify-center py-20 gap-6">
            ...
            <p className="text-orange-500/80 font-bold tracking-widest uppercase text-sm animate-pulse">جاري حساب النطاقات...</p>
          </div>
        ) : (
          <motion.div 
          ...
          >
            <div className="rounded-3xl border border-white/[0.05] bg-[#0d0d0d] p-6 shadow-xl relative overflow-hidden">
              <div className="text-center border-b border-white/5 pb-4 mb-4">
                <h2 className="text-base font-bold text-white/70">النطاق السعري المتوقع للأسبوع الحالي</h2>
              </div>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center justify-between p-6 rounded-xl bg-red-500/10 border border-red-500/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-bold text-white/80">الحد الأعلى (مقاومة)</span>
                      <span className="text-sm text-red-400/80 tracking-widest">أقصى صعود متوقع</span>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-6 rounded-xl bg-white/5 border border-white/10">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-bold text-white/80">الارتكاز (السعر الحالي)</span>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-6 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-bold text-white/80">الحد الأدنى (دعم)</span>
                      <span className="text-sm text-emerald-400/80 tracking-widest">أقصى هبوط متوقع</span>
                    </div>
                  </div>
