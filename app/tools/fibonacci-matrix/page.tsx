 ...
 *
 * Fibonacci Time & Price Matrix (ظ…طµظپظˆظپط© ظپظٹط¨ظˆظ†ط§طھط´ظٹ ط§ظ„ط²ظ…ظ†ظٹط© ظˆط§ظ„ط³ط¹ط±ظٹط©)
...
export default function FibMatrixPage() {
  ...
  const handleCalculate = () => {
    ...
    try {
      ...
      console.error(err);
      setError(err.message || 'ط­ط¯ط« ط®ط·ط£ ط£ط«ظ†ط§ط، ط­ط³ط§ط¨ ط§ظ„ظ…طµظپظˆظپط©.');
      setLoading(false);
    }
  };
    ...
    <div className="flex flex-col h-full bg-[#0a0a0a] overflow-y-auto pb-10" dir="rtl">
      ...
      <div className="px-5 pt-5 pb-4 flex flex-col gap-1">
        ...
        <h1 className="text-xl font-black text-white tracking-tight mt-1">
          ظ…طµظپظˆظپط© ظپظٹط¨ظˆظ†ط§طھط´ظٹ (ط²ظ…ظ† ظˆط³ط¹ط±)
        </h1>
        <p className="text-sm text-white/40 font-mono leading-relaxed">
          ط¥ط³ظ‚ط§ط· طھظ‚ط§ط·ط¹ط§طھ ط§ظ„ط³ط¹ط± ظˆط§ظ„ط²ظ…ظ† ظ„طھط­ط¯ظٹط¯ ظ…ظ†ط§ط·ظ‚ ط§ظ„ظ‚طھظ„ (Kill Zones)
        </p>
      </div>
      ...
      <div className="px-5 flex flex-col gap-5">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md p-5 flex flex-col gap-6 shadow-xl shadow-black/50">
          ...
          >
            ...
            {loading ? 'ط¬ط§ط±ظٹ ط¨ظ†ط§ط، ط§ظ„ظ…طµظپظˆظپط©...' : 'طھط´ط؛ظٹظ„ ظ…طµظپظˆظپط© ظپظٹط¨ظˆظ†ط§طھط´ظٹ'}
          </button>
        </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <span className="text-sm font-bold text-white/50 mb-2 flex items-center gap-1.5">
                    <Clock className="w-3 h-3 text-cyan-400" /> ظ†ط§ظپط°ط© ط²ظ…ظ†ظٹط© ظ‚ط§ط¯ظ…ط©
                  </span>
                  <span className="text-xl font-black text-cyan-400 font-mono tracking-tighter">
                    ط´ظ…ط¹ط© {result.nearestTimeWindow}
                  </span>
                  <span className="text-sm text-white/40 mt-1">طھط±ظ‚ط¨ ط§ظ„ط§ظ†ط¹ظƒط§ط³ ط­ظˆظ„ ظ‡ط°ط§ ط§ظ„ظ†ط·ط§ظ‚</span>
                </motion.div>
                ...
                >
                  <span className="text-sm font-bold text-white/50 mb-2 flex items-center gap-1.5">
                    <Target className="w-3 h-3 text-amber-400" /> ظ‡ط¯ظپ ط³ط¹ط±ظٹ ظ‚ط§ط¯ظ…
                  </span>
                  <span className="text-xl font-black text-amber-400 font-mono tracking-tighter">
                    ${priceStr(result.nearestPriceTarget)}
                  </span>
                  <span className="text-sm text-white/40 mt-1">ط§ظ„ظ‡ط¯ظپ ط§ظ„ط°ظ‡ط¨ظٹ (0.618)</span>
                </motion.div>
              </div>
              ...
              <motion.div 
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-bold text-rose-500/80 mb-0.5">ظ…ظ†ط§ط·ظ‚ ط§ظ„ظ‚طھظ„ (Kill Zones) ط§ظ„ظ…ظƒطھط´ظپط©</span>
                    <span className="text-base font-black text-rose-300">
                      ظٹظˆط¬ط¯ {result.killZones.length} ظ…ظ†ط§ط·ظ‚ طھظ‚ط§ط·ط¹ ط²ظ…ظ†ظٹط© ظˆط³ط¹ط±ظٹط© ط®ط·ط±ط© ظپظٹ ط§ظ„ظ…طµظپظˆظپط©.
                    </span>
                  </div>
              </motion.div>
