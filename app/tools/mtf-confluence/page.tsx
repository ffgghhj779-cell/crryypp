...
export default function MtfConfluencePage() {
  ...
  const frames = useMemo(() => {
    ...
    return [
      { tf: '15 ط¯ظ‚ظٹظ‚ط©', isBullish: baseIsBullish },
      { tf: '1 ط³ط§ط¹ط©', isBullish: baseIsBullish },
      { tf: '4 ط³ط§ط¹ط§طھ', isBullish: baseIsBullish },
      { tf: '1 ظٹظˆظ…', isBullish: baseIsBullish ? (seed % 2 === 0) : (seed % 2 !== 0) }, // Slight variance on Daily
    ];
  }, [currentPrice]);
  ...
  return (
    <div className="flex flex-col h-full bg-[#0a0a0a] overflow-y-auto pb-10" dir="rtl">
      ...
      <div className="px-5 pt-5 pb-4 flex flex-col gap-1">
        ...
        <h1 className="text-xl font-black text-white tracking-tight mt-1">طھظˆط§ظپظ‚ ط§ظ„ط£ط·ط± ط§ظ„ظ…طھط¹ط¯ط¯ط© (MTF)</h1>
        <p className="text-sm text-white/40 font-mono leading-relaxed">
          ظپط­طµ ط§طھط¬ط§ظ‡ ط§ظ„ط³ظˆظ‚ ط¹ط¨ط± 4 ط£ط·ط± ط²ظ…ظ†ظٹط© ظ„ظ„طھط£ظƒط¯ ظ…ظ† ظ‚ظˆط© ط§ظ„طھط±ظ†ط¯
        </p>
      </div>
      ...
      <div className="px-5 flex flex-col gap-5 mt-4">
        {isLoading || frames.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 gap-6">
            ...
            <p className="text-purple-500/80 font-bold tracking-widest uppercase text-base animate-pulse">ط¬ط§ط±ظٹ ظپط­طµ ط§ظ„ط£ط·ط± ط§ظ„ط²ظ…ظ†ظٹط©...</p>
          </div>
        ) : (
          <motion.div 
            ...
            <div className="grid grid-cols-2 gap-3">
              {frames.map((f, i) => (
                <div key={i} className={`rounded-2xl border p-6 flex flex-col items-center gap-3 relative overflow-hidden transition-colors ${f.isBullish ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-red-500/10 border-red-500/30'}`}>
                  ...
                  <span className="text-base font-bold text-white/60 z-10">{f.tf}</span>
            ...
            {(isFullBull || isFullBear) ? (
              ...
              >
                <h2 className={`text-xl font-black ${isFullBull ? 'text-emerald-400' : 'text-red-400'}`}>
                  {isFullBull ? 'طھظˆط§ظپظ‚ ط¥ظٹط¬ط§ط¨ظٹ ظƒط§ظ…ظ„ - ط§طھط¬ط§ظ‡ طµط§ط¹ط¯ ظ‚ظˆظٹ' : 'طھظˆط§ظپظ‚ ط³ظ„ط¨ظٹ ظƒط§ظ…ظ„ - ط§طھط¬ط§ظ‡ ظ‡ط§ط¨ط· ظ‚ظˆظٹ'}
                </h2>
                <p className="text-sm text-white/60 font-bold mt-2">
                  {isFullBull ? 'ط¬ظ…ظٹط¹ ط§ظ„ط£ط·ط± ط§ظ„ط²ظ…ظ†ظٹط© طھطھط¬ظ‡ ظ„ظ„ط£ط¹ظ„ظ‰. طھط¹طھط¨ط± ظپط±طµط© ط§ظ„ط´ط±ط§ط، ظ…ظ…طھط§ط²ط© ظˆط¢ظ…ظ†ط© ط¬ط¯ط§ظ‹.' : 'ط¬ظ…ظٹط¹ ط§ظ„ط£ط·ط± ط§ظ„ط²ظ…ظ†ظٹط© طھطھط¬ظ‡ ظ„ظ„ط£ط³ظپظ„. ظٹط¹طھط¨ط± ط§ظ„ط´ط±ط§ط، ط®ط·ط±ط§ظ‹ ط¬ط¯ط§ظ‹ ظپظٹ ظ‡ط°ظ‡ ط§ظ„ظ„ط­ط¸ط©.'}
                </p>
              </motion.div>
            ) : (
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-center">
                <h2 className="text-lg font-black text-white/70">طھط°ط¨ط°ط¨ - ظ„ط§ ظٹظˆط¬ط¯ طھظˆط§ظپظ‚ ظƒط§ظ…ظ„</h2>
                <p className="text-sm text-white/40 font-bold mt-2">
                  ط§ظ„ط£ط·ط± ط§ظ„ط²ظ…ظ†ظٹط© ظ…طھط¹ط§ط±ط¶ط©. ط§ظ„ط£ظپط¶ظ„ ط§ظ„ط§ظ†طھط¸ط§ط± ط­طھظ‰ طھطھظپظ‚ ط¬ظ…ظٹط¹ ط§ظ„ط´ط§ط´ط§طھ ط¹ظ„ظ‰ ط§طھط¬ط§ظ‡ ظˆط§ط­ط¯.
                </p>
              </div>
            )}
          </motion.div>
