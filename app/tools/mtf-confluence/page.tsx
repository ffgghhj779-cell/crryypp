      ...
      <div className="px-4 flex flex-col gap-5 mt-4">
        {isLoading || frames.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-purple-500/80 font-bold tracking-widest uppercase text-xs animate-pulse">جاري فحص الأطر الزمنية...</p>
          </div>
        ) : (
          <motion.div 
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {frames.map((f, i) => (
                <div key={i} className={`rounded-2xl border p-4 flex flex-col items-center gap-3 relative overflow-hidden transition-colors ${f.isBullish ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-red-500/10 border-red-500/30'}`}>
                  {f.isBullish ? (
                  ...
                  <span className="text-xs font-bold text-white/60 z-10">{f.tf}</span>
                  ...
                  <span className={`text-[10px] font-black uppercase tracking-widest z-10 ${f.isBullish ? 'text-emerald-400' : 'text-red-400'}`}>
            ...
            {(isFullBull || isFullBear) ? (
              ...
              >
                ...
                <p className="text-[11px] text-white/60 font-bold mt-2">
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-center">
                ...
                <p className="text-[11px] text-white/40 font-bold mt-2">
