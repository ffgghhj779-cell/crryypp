      ...
      <div className="px-5 flex flex-col gap-5">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md p-5 flex flex-col gap-6 shadow-xl shadow-black/50">
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-white/50 uppercase tracking-widest flex items-center gap-1.5">رمز الأصل المالي (Spot)</label>
            <input
              type="text"
              value={localSymbol}
      ...
      >
        ...
        <div className="flex justify-between items-end w-full">
          <div className="flex flex-col items-start gap-1">
            <span className="text-sm font-mono text-white/40 uppercase tracking-widest flex items-center gap-1"><Crosshair className="w-3 h-3" /> Entry / الدخول</span>
            ...
            <div className="p-6 border-t border-white/[0.04] flex flex-col gap-6">
              ...
              <div className="rounded-lg bg-red-500/5 border border-red-500/10 p-3 flex flex-col gap-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-base font-black text-red-400 font-mono">{setup.stopLoss}</span>
                </div>
                <span className="text-sm text-red-500/60 leading-relaxed font-bold">الإلغاء الصارم: إغلاق أسفل هذا المستوى</span>
              </div>
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-black text-orange-500 tracking-widest uppercase">دليل القراءة (المنهجية)</span>
        </div>
