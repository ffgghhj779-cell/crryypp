        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md p-5 flex flex-col gap-6 shadow-xl shadow-black/50">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="BTCUSDT"
              className="w-full rounded-xl bg-black/40 border border-white/[0.08] text-white font-mono text-base px-5 py-4 placeholder:text-white/20 focus:outline-none focus:border-rose-500/40 transition-colors"
              dir="ltr"
            />
          </div>
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-rose-500/80 mb-1">خلاصة طاقة الزخم</span>
