 ...
 *
 * Momentum Intelligence (ذكاء الزخم)
    ...
    <div className="flex flex-col h-full bg-[#0a0a0a] overflow-y-auto pb-10" dir="rtl">
      ...
      <div className="px-4 pt-5 pb-4 flex flex-col gap-1">
        <div className="flex items-center gap-2">
          <span className="text-[9px] font-black text-rose-500/70 tracking-widest uppercase border border-rose-500/20 bg-rose-500/10 px-2.5 py-1 rounded-full flex items-center gap-1">
            <Gauge className="w-3 h-3" /> Kinetic Engine
          </span>
        </div>
        <h1 className="text-xl font-black text-white tracking-tight mt-1">
          ذكاء الزخم والمحركات
        </h1>
        <p className="text-[12px] text-white/40 font-mono leading-relaxed">
          قياس سرعة وطاقة حركة السعر بدمج (RSI, MACD, Stochastic)
        </p>
      </div>
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md p-5 flex flex-col gap-4 shadow-xl shadow-black/50">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="BTCUSDT"
              className="w-full rounded-xl bg-black/40 border border-white/[0.08] text-white font-mono text-sm px-4 py-3 placeholder:text-white/20 focus:outline-none focus:border-rose-500/40 transition-colors"
              dir="ltr"
            />
          </div>
          ...
          >
            ...
            {loading ? 'جاري تقييم الزخم...' : 'تشغيل محرك الزخم'}
          </button>
        </div>
        ...
        <AnimatePresence>
          {result && (
            ...
            >
              ...
              <div className="flex items-center gap-4 bg-[#111] border border-white/[0.05] rounded-2xl p-5 shadow-xl shadow-rose-900/10 relative overflow-hidden">
                ...
                <div className="flex flex-col gap-2 z-10 flex-1">
                  ...
                  <span className="text-base font-black mt-1 tracking-wide" style={{ color: getGaugeColor(result.globalScore) }}>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="flex flex-col p-3 rounded-xl border border-white/[0.05] bg-white/[0.02] items-center text-center gap-1.5">
                  <span className="text-[10px] font-bold text-white/50 uppercase tracking-wider">RSI (14)</span>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-[9px] text-white/60 font-bold">{result.indicators.rsi.statusAr}</span>
                  </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex flex-col p-3 rounded-xl border border-white/[0.05] bg-white/[0.02] items-center text-center gap-1.5">
                  <span className="text-[10px] font-bold text-white/50 uppercase tracking-wider">MACD Hist</span>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-[9px] text-white/60 font-bold">{result.indicators.macd.statusAr}</span>
                  </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="flex flex-col p-3 rounded-xl border border-white/[0.05] bg-white/[0.02] items-center text-center gap-1.5">
                  <span className="text-[10px] font-bold text-white/50 uppercase tracking-wider">Stoch %K</span>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-[9px] text-white/60 font-bold">{result.indicators.stoch.statusAr}</span>
                  </div>
                </motion.div>
              </div>
              ...
              <motion.div 
                ...
                className="flex items-start gap-3 p-4 rounded-xl border border-rose-500/20 bg-rose-500/5 mt-1"
              >
                <Info className="w-5 h-5 text-rose-400 shrink-0 mt-0.5" />
                <div className="flex flex-col">
                  <span className="text-[11px] font-bold text-rose-500/80 mb-1">خلاصة طاقة الزخم</span>
                  <span className="text-[13px] font-bold text-white/90 leading-relaxed">
                    {result.insightAr}
                  </span>
                </div>
              </motion.div>
