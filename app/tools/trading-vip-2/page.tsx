 ...
 *
 * Trading VIP 2 - Liquidity & VWAP Engine (ط³ظˆظٹظ†ط¬ VIP طھط¬ظ…ظٹط¹ ط³ظٹظˆظ„ط©)
    ...
    <div className="flex flex-col h-full bg-[#0a0a0a] overflow-y-auto pb-10" dir="rtl">
      ...
      <div className="px-5 pt-5 pb-4 flex flex-col gap-1">
        ...
        <h1 className="text-xl font-black text-white tracking-tight mt-1">
          ط³ظˆظٹظ†ط¬ VIP طھط¬ظ…ظٹط¹ ط³ظٹظˆظ„ط©
        </h1>
        <p className="text-sm text-white/40 font-mono leading-relaxed">
          ظ†ط¸ط§ظ… طھط¬ظ…ظٹط¹ظٹ ظ…ط¨ظ†ظٹ ط¹ظ„ظ‰ ط§ظ„ط§ظ†ط­ط±ط§ظپط§طھ ط§ظ„ظ…ط¹ظٹط§ط±ظٹط© ظ„ظ…ط¤ط´ط± VWAP (T-6 ط¥ظ„ظ‰ T-10)
        </p>
      </div>
      ...
      <div className="px-5 flex flex-col gap-5">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md p-5 flex flex-col gap-6 shadow-xl shadow-black/50">
          ...
          >
            ...
            {loading ? 'ط¬ط§ط±ظٹ ط§ظ„طھط­ظ„ظٹظ„...' : 'طھط´ط؛ظٹظ„ ظ…ط­ط±ظƒ ط§ظ„ط³ظٹظˆظ„ط©'}
          </button>
        </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3 p-3 rounded-lg bg-orange-500/5 border border-orange-500/10">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-base font-black text-red-400">{setup.stopLossLabel}</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 mt-2">
              ...
              <div className="grid grid-cols-1 gap-3">
                {[
                  { lbl: setup.tp1Label, val: setup.tp1, pct: setup.profitPct1, title: 'ط§ظ„ظ‡ط¯ظپ ط§ظ„ط£ظˆظ„' },
                  { lbl: setup.tp2Label, val: setup.tp2, pct: setup.profitPct2, title: 'ط§ظ„ظ‡ط¯ظپ ط§ظ„ط«ط§ظ†ظٹ' },
                  { lbl: setup.tp3Label, val: setup.tp3, pct: setup.profitPct3, title: 'ط§ظ„ظ‡ط¯ظپ ط§ظ„ط«ط§ظ„ط«' }
                ].map((tp, i) => (
