      ...
      <div className="px-5 flex flex-col gap-5 mt-4">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-6">
            ...
            <p className="text-emerald-500/80 font-bold tracking-widest uppercase text-sm animate-pulse">جاري حساب الإحصاءات...</p>
          </div>
        ) : (
          <motion.div 
          ...
          >
            ...
            <div className="rounded-3xl border border-white/[0.08] bg-[#111] p-6 flex flex-col items-center gap-6 relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 text-white/50">
                ...
                <span className="text-sm font-bold tracking-widest uppercase">متبقي للإغلاق (UTC 00:00)</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="rounded-2xl border border-white/[0.05] bg-[#0d0d0d] p-5 flex flex-col gap-3">
                <span className="text-sm text-white/40 font-bold uppercase tracking-widest">الافتتاح (Open)</span>
              ...
              <div className="rounded-2xl border border-white/[0.05] bg-[#0d0d0d] p-5 flex flex-col gap-3">
                <span className="text-sm text-white/40 font-bold uppercase tracking-widest">السعر الحالي (Now)</span>
                <span className="text-xl font-black text-white/90 font-mono">
                  ${currentPrice != null
            ...
            <div className={`rounded-2xl border p-5 flex flex-col items-center justify-center gap-3 ${isPositive ? 'bg-emerald-500/10 border-emerald-500/20' : 'bg-red-500/10 border-red-500/20'}`}>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col" dir="ltr">
                  ...
                  <span className={`text-sm font-mono font-bold mt-1 ${isPositive ? 'text-emerald-500/60' : 'text-red-500/60'}`}>
