    ...
    <div className="flex flex-col h-full bg-[#0a0a0a] overflow-y-auto pb-10" dir="rtl">
      ...
      <div className="px-4 flex flex-col gap-5 mt-4">
        ...
        <div className="rounded-2xl border border-white/[0.05] bg-[#0d0d0d] p-5 shadow-xl relative overflow-hidden">
          ...
          <label className="text-xs font-bold text-white/60 mb-3 flex items-center gap-2">
          ...
          <input 
            ...
            className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-white font-mono text-lg focus:outline-none focus:border-emerald-500/50 transition-colors dir-ltr text-right placeholder:text-white/20"
          />
        </div>
            ...
            return (
              <div key={i} className="rounded-2xl border border-white/[0.05] bg-[#111] p-5 flex items-center justify-between relative overflow-hidden group">
                ...
                <div className="flex flex-col pr-3">
                  ...
                  <span className="text-[10px] text-white/40 mt-1">الهدف المتوقع بناءً على السعر المدخل</span>
                </div>
